...
const numbersArray:Array<number> = [2, 56, 44, 66, 5, 3]; 
...
const descendingSortedArray: Array<number> = numbersArray.sort((a, b) => b - a)
const escendingSortedArray: Array<number> = numbersArray.sort((a, b) => a - b)

...
const numbersArray:Array<any> = [2, 56, 44, 66, 5, 3];
...
const biggerThen10: Array<any> = numbersArray.filter(number => number > 10);

console.log("Numbers bigger than 10:", biggerThen10);
// ----- 1.5. ----- //
//1.5. Return all the numbers that are divisible by 2.

const numbersDivby2: Array<any> = numbersArray.filter(number => number % 2 === 0);
...
const oddNumbers: Array<any> = numbersArray.filter(number => number % 2 !== 0)
...
const numbersMultipliedBy4: Array<any> = numbersArray.map(number => number * 4)
...
const stringNumbersArray: Array<any> = numbersArray.map(number => String(number));
...
const newArrayWithKeys: Array<any> = numbersArray.map(number => ({ key: number }));

console.log("Array with keys:", newArrayWithKeys);

// ----- 1.10. ----- //
// 1.10. Return descending sorted array.
const descendingSortedArray: Array<any> = numbersArray.sort((a, b) => b - a)
